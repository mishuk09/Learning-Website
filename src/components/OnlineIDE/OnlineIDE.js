import { faBookOpen, faBriefcase, faBug, faCode, faFilePdf, faGear, faMagnifyingGlass, faNewspaper, faRunning, faThumbsUp, faUserGraduate } from '@fortawesome/free-solid-svg-icons';
...
const OnlineIDE = () => {
    ...
    return (
        <div>
            ...
            <div style={{ backgroundColor: '#0e1117' }} className='  relative pb-20 h-[560px]'>
            ...
            <div className='container flex mt-1  justify-center items-center mb-[150px] '>
