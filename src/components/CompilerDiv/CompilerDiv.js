    ...
    return (
        <div className='container'>
            <div className='  flex w-full mt-10 border rounded border-slate-400'>
                ...
                <div className='h-36 w-[25%] border-t border-r border-b bg-emerald-300 flex items-center justify-center' ><Button className='bg-black rounded'>Code Now</Button></div>
